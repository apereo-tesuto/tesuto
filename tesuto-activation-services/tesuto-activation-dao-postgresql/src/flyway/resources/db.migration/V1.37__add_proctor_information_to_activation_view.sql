...
select activation_id, user_id, start_date, end_date, status,
	   ...
	   null as proctor_first_name, null as proctor_last_name,
	   null as proctor_email, null as proctor_phone
...
select act.activation_id, act.user_id, ev.start_date, ev.end_date, act.status,
	   ...
	   ev.proctor_first_name, ev.proctor_last_name,
	   ev.proctor_email, ev.proctor_phone
