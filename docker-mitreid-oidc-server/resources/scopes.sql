...
INSERT INTO system_scope_TEMP (scope, description, icon, restricted, default_scope) VALUES
  ...
  ('student', 'student', 'user', false, true),
  ('superuser', 'superuser', 'user', false, true),
  ('godtool', 'God Tool', 'user', false, true),
  ('cccid', 'CCCID', 'user', false, true),
  ('tesuto_service', 'Client Tesuto Service', 'user', false, true);
