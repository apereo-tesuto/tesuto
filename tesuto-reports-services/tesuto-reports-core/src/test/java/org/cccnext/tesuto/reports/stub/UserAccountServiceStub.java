...
public class UserAccountServiceStub implements UserAccountService {
    ...
    private Map<String, UserAccountDto> users = new HashMap<>();
    @Override
    ...
    public UserAccountDto upsert(UserAccountDto userAccountDto) {
        users.put(userAccountDto.getUserAccountId(), userAccountDto);
        users.put(userAccountDto.getUsername(), userAccountDto);
        return userAccountDto;
    }
