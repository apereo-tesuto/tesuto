...
<html ccc-lang>
    <head>
        ...
        <title ccc-update-page-title>Assessment Player</title>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/common/dynamic/scripts.api.activity.jsp" />
        ...
        <jsp:include page="/WEB-INF/common/dynamic/scripts.view.assessmentPlayer.jsp" />
        ...
        <script>
            ...
            (function () {
                ...
                angular.element(document).ready(function () {
                    angular.bootstrap(document, ['CCC.View.AssessmentPlayer']);
                });
