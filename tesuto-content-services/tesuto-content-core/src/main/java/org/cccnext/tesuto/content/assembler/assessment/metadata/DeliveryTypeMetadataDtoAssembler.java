 ...
 */
public interface DeliveryTypeMetadataDtoAssembler extends DtoAssembler<DeliveryTypeMetadataDto, DeliveryTypeMetadata> {

    @Override
    DeliveryTypeMetadataDto assembleDto(DeliveryTypeMetadata deliveryTypeMetadata);

    @Override
    DeliveryTypeMetadata disassembleDto(DeliveryTypeMetadataDto deliveryTypeMetadataDto);
}
