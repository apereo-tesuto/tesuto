 ...
 */
public interface AssessmentInteractionDtoAssembler
        extends DtoAssembler<AssessmentInteractionDto, AssessmentInteraction> {
    @Override
    AssessmentInteractionDto assembleDto(AssessmentInteraction interaction);

    @Override
    AssessmentInteraction disassembleDto(AssessmentInteractionDto interactionDto);
}
