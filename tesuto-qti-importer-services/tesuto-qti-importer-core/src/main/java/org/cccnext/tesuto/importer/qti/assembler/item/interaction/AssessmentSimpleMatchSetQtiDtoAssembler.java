 ...
 */
public interface AssessmentSimpleMatchSetQtiDtoAssembler
        extends DtoAssembler<AssessmentSimpleMatchSetDto, SimpleMatchSet> {
    @Override
    AssessmentSimpleMatchSetDto assembleDto(SimpleMatchSet simpleMatchSet);

    @Override
    SimpleMatchSet disassembleDto(AssessmentSimpleMatchSetDto assessmentSimpleMatchSetDto);
}
