...
(function () {
    ...
    angular.module('CCC.View.AssessmentPrototype').directive('cccViewAssessmentComplete', function () {
            ...
            controller: [
                ...
                function ($scope, $element, $stateParams) {
                    ...
                    var goToStudentActivationStatus = function () {
                        ...
                        var completionURL = window.location.origin + '/ccc-assess/student?assessmentSessionId=' + $scope.assessment.assessmentSessionId;
                                    ...
                                    '<div class="col-xs-12">',
                                        '<nav class="navbar navbar-default" role="navigation" id="app-main-nav">',
                                            '<div class="navbar-header">',
                                                '<a class="navbar-brand logo" href="#" id="ccc-header-nav-logo"><span class="navbar-brand-content"><img class="logo-mark" src="ui/resources/images/multiple_measures_white.png" alt="CCC logo mark"><span class="logo-text">Tesuto</span></span></a>',
                                            '</div>',
                                        '</nav>',
                                    '</div>',
                                '</div>',
                    ...
                    '<div class="row">',
                        ...
                        '<div class="col-xs-12">',
                            ...
                            '<div id="ccc-assessment-complete-label">',
                                ...
                                '<h2 class="reading-width"><span translate="CCC_VIEW_ASSESSMENT_PLAYER.COMPLETION.BODY" translate-values="{ASSESSMENT_NAME: assessmentTitle}"></span></h2>',

                            '</div>',

                            '<p>',
                                '<button tabindex="0" ccc-autofocus class="btn btn-primary btn-submit-button" ng-click="continue()" aria-labelledby="ccc-assessment-complete-label">',
