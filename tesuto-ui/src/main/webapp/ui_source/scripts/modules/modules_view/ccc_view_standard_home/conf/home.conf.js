...
(function () {
    ...
    angular.module('CCC.View.Home').config([
        ...
        function (CurrentUserServiceProvider, RoutePermissionsServiceProvider, SESSION_CONFIGS) {

            CurrentUserServiceProvider.setUser(SESSION_CONFIGS.user);
            RoutePermissionsServiceProvider.setPermissions(CurrentUserServiceProvider.getPermissions());
        }
    ]);
