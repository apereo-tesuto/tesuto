...
@Service("assessmentItemCacheDao")
public class AssessmentItemRepositoryCache implements AssessmentItemRepository,InitializingBean {

	private Cache assessmentItemCache;
	
	@Value("${assessmentItemCacheName}")
	...
	public void afterPropertiesSet() {
		...
		assessmentItemCache = (Cache) cacheManager.getCache(cacheName);
	}
