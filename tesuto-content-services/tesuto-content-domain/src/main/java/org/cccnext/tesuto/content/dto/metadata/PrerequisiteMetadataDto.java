...
public class PrerequisiteMetadataDto implements AbstractAssessmentDto {
    private static final long serialVersionUID = 1l;
    private String assessmentIdRef;

    /**
     * Without this Jackson Serialization will throw exception if no child nodes
     * are defined. The author has defined the preRequisite node but not the
     * assessmentIdRef
     */
    public PrerequisiteMetadataDto(String notUsed) {
        this.assessmentIdRef = null;
    }

    public PrerequisiteMetadataDto() {
    }
