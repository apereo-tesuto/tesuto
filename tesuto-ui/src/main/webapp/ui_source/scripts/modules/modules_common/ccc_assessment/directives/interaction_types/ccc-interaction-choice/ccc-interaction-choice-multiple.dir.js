...
(function () {
    ...
    angular.module('CCC.Assessment').directive('cccInteractionChoiceMultiple', [function () {
        ...
        return {
            ...
            controller: [
                ...
                function ($scope) {
                    ...
                    $scope.itemClicked = function (event, choice) {
                        ...
                        var indexOfChoiceSelected = $scope.interaction.values.indexOf(choice.identifier);

                        if (indexOfChoiceSelected !== -1) {
                            $scope.interaction.values.splice(indexOfChoiceSelected, 1);
                        } else {
            ...
            template: [
                ...
                '<div role="group" class="ccc-interaction-choice-list clearfix" ng-class="{horizontal: interaction.orientation == \'horizontal\'}">',

                    '<div class="ccc-interaction-choice-item-wrapper" ng-repeat="choice in interaction.choices">',
                        '<label class="ccc-interaction-choice-item-label choice-item-input-checkbox">',
                            ...
                            '<span class="ccc-interaction-choice-item-input-wrapper">',
                                '<input class="ccc-interaction-choice-item-input" type="checkbox" ',
