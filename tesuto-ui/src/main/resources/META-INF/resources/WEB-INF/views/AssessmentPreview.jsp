...
<html ccc-lang>
    <head>
        ...
        <title ccc-update-page-title>CCC Assessment Preview</title>
        ...
        <!-- VIEW STYLES -->
        <link rel='stylesheet' href='${pageContext.request.contextPath}/ui/styles/css/views/view_assessment_preview.css' />

    </head>

    <!-- INITIAL MARKUP -->
    <body>
        <ccc-view-assessment-preview></ccc-view-assessment-preview>
        ...
        <!-- API MODULES -->
        <jsp:include
            page="/WEB-INF/common/dynamic/scripts.api.assessmentSessionsPreview.jsp" />


        <!--============ VIEW MODULE ============-->

        <jsp:include
            page="/WEB-INF/common/dynamic/scripts.view.assessmentPreview.jsp" />
        ...
        <script>
            (function () {
                ...
                angular.element(document).ready(function () {
                    angular.bootstrap(document, ['CCC.View.AssessmentPreview']);
                });
