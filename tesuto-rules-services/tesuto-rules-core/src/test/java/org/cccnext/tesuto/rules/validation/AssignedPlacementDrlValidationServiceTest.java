...
public class AssignedPlacementDrlValidationServiceTest {

	@Autowired
	AssignedPlacementDrlValidationService service;

	@Test
	public void testPlacement() throws IOException {
		DrlValidationResults results = service.validate(getData("AssignedPlacementFull", "AssignedPlacement"));
