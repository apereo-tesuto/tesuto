...
/**
 * The RetryableMessageException should be thrown if the message that was send should be
 * replayed after a defined time delay.
 */
public class RetryableMessageException extends RuntimeException {
    ...
    public RetryableMessageException(Throwable cause) {
        super(cause);
    }
