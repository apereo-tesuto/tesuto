 ...
 */
public interface ChildExpressionEvaluationService {

    public boolean evaluateChildExpression(AssessmentChildExpressionDto childExpressionDto, EvaluationScoringModel evaluationScoringModel);
}
