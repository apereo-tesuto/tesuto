...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"mySuperSecurePassword"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"tesuto"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"tesuto"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"tesuto"}
