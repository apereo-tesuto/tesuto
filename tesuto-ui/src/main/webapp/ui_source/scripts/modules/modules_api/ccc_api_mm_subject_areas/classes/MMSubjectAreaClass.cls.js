...
(function () {
    ...
    angular.module('CCC.API.MMSubjectAreas').factory('MMSubjectAreaClass', [
        ...
        function ($q, Moment, $translate, Cloneable, CCCUtils, MMSubjectAreasAPIService) {
            ...
            var MMSubjectAreaClass = function (configs_in) {
                ...
                var defaults = {
                    ...
                    competencyAttributes: {
                        optInMultiMeasure: true, // this should never be changed... this is the default for this type of subject area.
                ...
                that.publish = function () {
                    return MMSubjectAreasAPIService.publish(that.disciplineId).then(function (newSubjectArea) {
                        return CCCUtils.coerce('MMSubjectAreaClass', newSubjectArea);
                    });
                };

                that.create = function () {

                    return MMSubjectAreasAPIService.create(that.serialize()).then(function (subjectAreaId) {
                ...
                that.update = function () {
                    return MMSubjectAreasAPIService.update(that.disciplineId, that.serialize());
                };

                that.delete = function () {
                    return MMSubjectAreasAPIService.delete(that.disciplineId);
                };
                ...
                that.fetchSequences = function () {
                    ...
                    return MMSubjectAreasAPIService.getSequences(that.disciplineId).then(function (sequences) {
