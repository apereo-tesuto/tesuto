...
import org.ccctc.common.droolsengine.config.TestConfigurationEngineDisabled;
...
classes={TestConfigurationEngineDisabled.class, DroolsRulesService.class, StudentProfileFacade.class,
		ContainerConfiguratorFactoryImpl.class, KieContainerFactory.class,
        NoOpActionService.class, StudentProfileFactsPreProcessor.class})
@TestPropertySource("classpath:application-test-enginedisabled.properties")
public class DroolsRulesServiceEngineDisabledTest {
    @Autowired
    private DroolsRulesService rulesService;
    
    @Test
    public void checkStatus() {
        assertEquals(DroolsEngineStatus.DISABLED, rulesService.getStatus());
    }
}
