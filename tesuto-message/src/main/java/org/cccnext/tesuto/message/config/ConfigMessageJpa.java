 ...
 * the License.
 ******************************************************************************/
package org.cccnext.tesuto.message.config;
...
@Configuration
@EnableJpaRepositories(basePackages={"org.cccnext.tesuto.message.repository.jpa"},
entityManagerFactoryRef="entityManagerFactoryMessage",
queryLookupStrategy=Key.CREATE_IF_NOT_FOUND,
transactionManagerRef="transactionManagerMessage")
@EnableTransactionManagement(mode = AdviceMode.ASPECTJ)
public class ConfigMessageJpa {

	@Value("${JDBC_URL_MESSAGE}")
	private String jdbcUrl;

	@Value("${JDBC_USER_MESSAGE}")
	private String jdbcUser;

	@Value("${JDBC_PASSWORD_MESSAGE}")
	String jdbcPassword;
	...
	@Bean(name = "sqlDataSourceMessage", destroyMethod = "close")
	...
	@Bean(name = "persistentUnitManagerMessage")
	public PersistenceUnitManager persistentUnitManager() throws PropertyVetoException {
		...
		unitManager.setPackagesToScan("org.cccnext.tesuto.message.model");
		return unitManager;
	}

	@Bean(name = "entityManagerFactoryMessage")
	...
	@Bean(name = "transactionManagerMessage")
