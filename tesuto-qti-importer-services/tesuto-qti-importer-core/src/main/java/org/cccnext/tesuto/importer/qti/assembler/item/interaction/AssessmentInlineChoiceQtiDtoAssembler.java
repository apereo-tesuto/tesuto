 ...
 */
public interface AssessmentInlineChoiceQtiDtoAssembler extends DtoAssembler<AssessmentInlineChoiceDto, InlineChoice> {
    @Override
    AssessmentInlineChoiceDto assembleDto(InlineChoice inlineChoice);

    @Override
    InlineChoice disassembleDto(AssessmentInlineChoiceDto assessmentInlineChoiceDto);
}
