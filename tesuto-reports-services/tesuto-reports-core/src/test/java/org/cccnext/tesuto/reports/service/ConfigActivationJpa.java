...
@Configuration
@EnableJpaRepositories(basePackages={"org.cccnext.tesuto.activation"},
entityManagerFactoryRef="entityManagerFactoryActivation",
queryLookupStrategy=Key.CREATE_IF_NOT_FOUND,
transactionManagerRef="transactionManagerActivation")
@EnableTransactionManagement(mode = AdviceMode.ASPECTJ)
public class ConfigActivationJpa {

	@Value("${JDBC_URL_ACTIVATION}")
	private String jdbcUrl;

	@Value("${JDBC_USER_ACTIVATION}")
	private String jdbcUser;

	@Value("${JDBC_PASSWORD_ACTIVATION}")
	String jdbcPassword;
	...
	@Bean(name = "sqlDataSourceActivation", destroyMethod = "close")
	...
	@Bean(name = "persistentUnitManagerActivation")
	public PersistenceUnitManager persistentUnitManagerAdmin() throws PropertyVetoException {
		...
		unitManager.setPackagesToScan("org.cccnext.tesuto.activation");
		return unitManager;
	}

	@Bean(name = "entityManagerFactoryActivation")
	...
	@Bean(name = "transactionManagerActivation")
