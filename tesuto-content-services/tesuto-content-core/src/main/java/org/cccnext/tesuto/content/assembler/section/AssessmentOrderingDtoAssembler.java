 ...
 */
public interface AssessmentOrderingDtoAssembler extends DtoAssembler<AssessmentOrderingDto, AssessmentOrdering> {
    @Override
    AssessmentOrderingDto assembleDto(AssessmentOrdering ordering);

    @Override
    AssessmentOrdering disassembleDto(AssessmentOrderingDto orderingDto);
}
