...
<body class="login">
	...
	<div class="container">
		<div class="row">
			<div
				class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 ccc-login-card">
				<div class="titlebar">
					<h1>Sign in</h1>
				</div>
				<form id="login_form" action="${loginUrl}" method="POST">
					<div class="form-group">
						<label for="j_username">Username</label> <input id="j_username"
							name="j_username" type="text" class="form-control input-lg"
							placeholder="Username">
					</div>
					<div class="form-group">
						<label for="j_password">Password</label> <input id="j_password"
							name="j_password" type="password" class="form-control input-lg"
							placeholder="Password">
					</div>
					<button id="login_button" name="submit" type="submit"
						class="btn btn-primary btn-lg center-block">Sign in</button>
