    ...
    $(document).ready(function() {
		...
		$( '#uploadPreviewForm' )
			.submit( function( e ) {
				...
				$.ajax( {
					url:  baseUrl + '/service/v1/preview/upload',
					type: 'POST',
...
<div class="main-content-wrapper">
	<div class="main-content">
		<div class="panel panel-default">
			<div class="panel-heading"><h2>Preview</h2></div>
			<div class="panel-body">
			<form id="uploadPreviewForm" action="javascript:;" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<label>Upload by Selecting a Content Package ZIP file or Assessment Item XML file to preview and validate:</label>
				...
				<div>
					<aside>
						...
						<ul>
							...
							<li>An IMS Content Package containing a QTI (2.0 - 2.2) Assessment
								Test(s), its Assessment Items, plus any related resources.</li>
							<li>A self-contained Assessment Item XML file - QTI (2.0 - 2.2).</li>
						</ul>
					</aside>
				</div>
