 ...
 */
@Slf4j
@Component(value = "preconditionQtiDtoAssembler")
public class AssessmentPreconditionQtiDtoAssemblerImpl implements AssessmentPreconditionQtiDtoAssembler {

    @Autowired
    AssessmentParentExpressionQtiDtoAssembler parentExpressionQtiDtoAssembler;
    @Override
    public AssessmentPreConditionDto assembleDto(PreCondition preCondition) {
        ...
        preConditionDto.setAssessmentParentExpression(parentExpressionQtiDtoAssembler.assembleDto(preCondition.getExpression()));
        return preConditionDto;
    }

    @Override
    public PreCondition disassembleDto(AssessmentPreConditionDto preConditionDto) {
