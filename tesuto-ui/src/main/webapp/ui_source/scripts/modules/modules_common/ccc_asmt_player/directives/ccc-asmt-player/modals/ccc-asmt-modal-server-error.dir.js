...
(function () {
    ...
    angular.module('CCC.AsmtPlayer').directive('cccAsmtModalServerError', function () {
                ...
                '<div autofocus tabindex="-1" id="{{modal.labelId}}">',
                    ...
                    '<div class="modal-header">',
                        ...
                        '<h3 class="modal-title text-warning">',
                            ...
                            ' <span translate="CCC_PLAYER.SERVER_ERROR_MODAL.TITLE"></span>',
                        '</h3>',
                    ...
                    '<div class="modal-content-wrapper">',
                        ...
                        '<div class="modal-body" id="{{modal.contentId}}">',
                            '<p translate="CCC_PLAYER.SERVER_ERROR_MODAL.BODY"></p>',
                        '</div>',
                    '</div>',
