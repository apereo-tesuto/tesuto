 ...
 * the License.
 ******************************************************************************/
package org.cccnext.tesuto.delivery.model.view;
...
public class AssessmentSessionViewDto {

    @JsonIgnore
    private AssessmentSession internalSession;
    ...
    public AssessmentSession getInternalSession() {
        return internalSession;
    }

    public void setInternalSession(AssessmentSession internalSession) {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof AssessmentSessionViewDto))
            return false;

        AssessmentSessionViewDto that = (AssessmentSessionViewDto) o;
        ...
        if (getAssessmentSettings() != null ? !getAssessmentSettings().equals(that.getAssessmentSettings())
            ...
            return false;
        if (getCurrentTaskSet() != null ? !getCurrentTaskSet().equals(that.getCurrentTaskSet())
                : that.getCurrentTaskSet() != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (getCurrentTaskSet() != null ? getCurrentTaskSet().hashCode() : 0);
