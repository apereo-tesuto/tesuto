...
@Configuration
@EnableJpaRepositories(basePackages={"org.cccnext.tesuto.web.repository"},
...
public class ConfigWebJpa {

	// USES SAME database and schema as admin, would require a new flyway script and schema otherwise
	...
	@Primary
	@Bean(name = "sqlDataSourceWeb", destroyMethod = "close")
	...
	@Primary
	@Bean(name = "persistentUnitManagerWeb")
	public PersistenceUnitManager persistentUnitManagerWeb() throws PropertyVetoException {
		DefaultPersistenceUnitManager unitManager = new DefaultPersistenceUnitManager();
		unitManager.setDefaultDataSource(dataSource());
		unitManager.setPackagesToScan("org.cccnext.tesuto.web.model");
		return unitManager;
	}
	...
	public EntityManagerFactory localContainerEntityManagerFactoryBean() throws PropertyVetoException {
		...
		entityManagerFactory.setPersistenceUnitManager(persistentUnitManagerWeb());
