 ...
 */
public interface AssessmentBranchRuleQtiDtoAssembler extends DtoAssembler<AssessmentBranchRuleDto, BranchRule> {
    @Override
    AssessmentBranchRuleDto assembleDto(BranchRule branchRule);

    @Override
    BranchRule disassembleDto(AssessmentBranchRuleDto branchRuleDto);
}
