 ...
 */
public interface AssessmentInlineChoiceInteractionDtoAssembler
        extends DtoAssembler<AssessmentInlineChoiceInteractionDto, AssessmentInlineChoiceInteraction> {
    @Override
    AssessmentInlineChoiceInteractionDto assembleDto(
            AssessmentInlineChoiceInteraction assessmentInlineChoiceInteraction);

    @Override
    AssessmentInlineChoiceInteraction disassembleDto(
