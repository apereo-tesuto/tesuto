...
public class AssessmentAccessServiceCache implements AssessmentAccessService {
	...
	@Override
	public Collection<? extends AssessmentAccess> findByLocationsAndUserIds(Set<TestLocationDto> locations,
			Set<String> userIds) {
		//Auto-generated method stub
		return null;
	}
