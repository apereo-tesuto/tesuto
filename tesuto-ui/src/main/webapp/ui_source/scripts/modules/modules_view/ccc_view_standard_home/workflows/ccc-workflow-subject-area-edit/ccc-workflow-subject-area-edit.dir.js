...
(function () {
    ...
    angular.module('CCC.View.Home').directive('cccWorkflowSubjectAreaEdit', function () {
                ...
                function ($scope, ViewManagerEntity, SubjectAreasAPIService) {
                    ...
                    var addSubjectAreaEditView = function (subjectArea) {
                        ...
                        viewScope.$on('ccc-sa-wizard.cancel', function () {
                            $scope.$emit('ccc-workflow-subject-area-edit.cancel');
                        });

                        viewScope.$on('ccc-sa-wizard.complete', function (e, subjectArea, wizardInstance) {

                            SubjectAreasAPIService.subjectAreas.update(subjectArea.disciplineId, subjectArea.serialize()).then(function () {

                                $scope.$emit('ccc-workflow-subject-area-edit.complete', subjectArea);
                        ...
                        viewScope.$on('ccc-sa-wizard.stepChanged', function () {
                            $scope.viewManager.requestViewScrollUp('manage-placements-subject-area-edit-view', 200);
                        });

                        $scope.viewManager.pushView({
                            id: 'manage-placements-subject-area-edit-view',
                            title: 'Edit Subject Area',
                            breadcrumb: 'Edit Suject Area',
                            scope: viewScope,
                            template: '<ccc-sa-wizard subject-area="subjectArea" mode="edit"></ccc-sa-wizard>'
                        });
                    };
                    ...
                    addSubjectAreaEditView($scope.subjectArea);
                }
            ],
