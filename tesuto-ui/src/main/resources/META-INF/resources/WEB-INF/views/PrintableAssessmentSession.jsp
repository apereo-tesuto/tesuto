...
<html ccc-lang moznomarginboxes>
    ...
    <!-- INITIAL MARKUP -->
    <body>
        <ccc-view-assessment-print></ccc-view-assessment-print>
        ...
        <jsp:include page="/WEB-INF/common/dynamic/scripts.view.assessmentPrint.jsp" />
        ...
        <script>
            ...
            (function () {
                ...
                angular.element(document).ready(function () {
                    angular.bootstrap(document, ['CCC.View.AssessmentPrint']);
                });
