 ...
 */
public interface ItemMetadataDtoAssembler extends DtoAssembler<ItemMetadataDto, ItemMetadata> {

    @Override
    ItemMetadataDto assembleDto(ItemMetadata itemMetadata);

    @Override
    ItemMetadata disassembleDto(ItemMetadataDto itemMetadataDto);
}
