 ...
 */
@Slf4j
@Component(value = "orderingQtiDtoAssembler")
public class AssessmentOrderingQtiDtoAssemblerImpl implements AssessmentOrderingQtiDtoAssembler {

    @Override
    public AssessmentOrderingDto assembleDto(Ordering ordering) {
        ...
        orderingDto.setShuffle(ordering.getShuffle());

        return orderingDto;
    }

    @Override
    public Ordering disassembleDto(AssessmentOrderingDto orderingDto) {
