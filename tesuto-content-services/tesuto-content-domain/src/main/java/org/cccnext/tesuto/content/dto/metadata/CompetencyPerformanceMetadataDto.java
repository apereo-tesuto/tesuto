 ...
 */
public class CompetencyPerformanceMetadataDto implements AbstractAssessmentDto {
    private static final long serialVersionUID = 1l;

    @JacksonXmlElementWrapper(localName = "competencyCategories")
    @JacksonXmlProperty(localName = "competencyCategory")
    ...
    public List<CompetencyCategoryMetadataDto> getCompetencyCategoriesByDiscipline(String discipline) {
        return competencyCategories.stream().filter(cat -> cat.getCompetencyMapDiscipline().equalsIgnoreCase(discipline))
