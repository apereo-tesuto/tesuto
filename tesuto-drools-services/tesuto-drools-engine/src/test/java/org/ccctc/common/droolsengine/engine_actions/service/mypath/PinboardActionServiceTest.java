...
import org.ccctc.common.droolsengine.engine_actions.service.mypath.PinboardActionService;
...
@ContextConfiguration(loader = AnnotationConfigContextLoader.class,
    classes={PinboardActionService.class, TestingConfiguration.class})

@ComponentScan
@TestPropertySource("classpath:application-test.properties")
public class PinboardActionServiceTest {
    private static final String DEFAULT_CCCID = "abcde";
    private static final String DEFAULT_MIS_CODE = "ZZ1";
    private static final String DEFAULT_PINBOARD_FNAME = "my_fname";
    private MockRestServiceServer mockServer;

    @Autowired
    private PinboardActionService pinboardActionService;
    ...
    @Test
    public void nominal() {
        String targetUrl = config.getFavoritesUrl() + "/" + DEFAULT_CCCID + "/pinboard/launchers/" + DEFAULT_PINBOARD_FNAME;
        ...
        try {
            ...
            rulesAction.addActionParameter("pinboardFname", DEFAULT_PINBOARD_FNAME);
            List<String> errors = pinboardActionService.execute(rulesAction, facts);
