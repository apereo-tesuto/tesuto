...
// Generate a plain text file for non-HTML compatible email clients
function plaintext() {
...
function watch() {
  gulp.watch(['src/pages/**/*.html', 'src/pages/**/*.txt', 'src/data/**/*']).on('all', gulp.series(resetPages, pages, plaintext, inline, browser.reload));
