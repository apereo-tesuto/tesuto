 ...
 */
public interface AssessmentMetadataDtoAssembler extends DtoAssembler<AssessmentMetadataDto, AssessmentMetadata> {

    @Override
    AssessmentMetadataDto assembleDto(AssessmentMetadata assessmentMetadata);

    @Override
    AssessmentMetadata disassembleDto(AssessmentMetadataDto assessmentMetadataDto);
}
