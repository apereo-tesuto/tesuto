...
(function () {
    ...
    angular.module('CCC.Components').directive('cccModalUnauthorized', function () {
                ...
                '<div autofocus tabindex="0" id="{{modal.labelId}}">',
                    ...
                    '<div class="modal-header">',
                        ...
                        '<h3 class="modal-title text-warning">',
                            ...
                            ' <span translate="CCC_COMP.MODALS.UNAUTHORIZED.TITLE"></span>',
                        '</h3>',
                    ...
                    '<div class="modal-content-wrapper">',
                        ...
                        '<div class="modal-body" id="{{modal.contentId}}">',
                            '<p translate="CCC_COMP.MODALS.UNAUTHORIZED.BODY"></p>',
