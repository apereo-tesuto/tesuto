...
public interface PlacmentModelRepository extends JpaRepository<CollegePlacementModel, String>{

    CollegePlacementModel findByDisciplineIdAndIsDirty(Integer disciplineId, boolean isDirty);
    List<CollegePlacementModel> findByDisciplineId(Integer disciplineId);
}
