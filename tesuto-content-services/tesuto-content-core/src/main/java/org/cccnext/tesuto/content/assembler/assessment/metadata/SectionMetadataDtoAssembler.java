...
public interface SectionMetadataDtoAssembler extends DtoAssembler<SectionMetadataDto, SectionMetadata> {

    @Override
    public SectionMetadataDto assembleDto(SectionMetadata sectionsMetadata);

    @Override
    public SectionMetadata disassembleDto(SectionMetadataDto sectionsMetadataDto);
}
