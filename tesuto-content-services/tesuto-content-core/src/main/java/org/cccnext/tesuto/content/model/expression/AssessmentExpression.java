 ...
 */
public class AssessmentExpression implements AbstractAssessment {

    private AssessmentParentExpression assessmentParentExpression;

    public AssessmentParentExpression getAssessmentParentExpression() {
        return assessmentParentExpression;
    }

    public void setAssessmentParentExpression(AssessmentParentExpression assessmentParentExpression) {
