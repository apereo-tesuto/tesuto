    ...
    angular.module('CCC.View.Student').config([
        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider.state('home', {
                url: '/student',
                pageTitle: 'CCC_STUDENT.PAGE_TITLES.HOME',
                template: '<ccc-route-student-home></ccc-route-student-home>'
            });

            // this is where the assessment will forward a student after they are complete
            //original was ccc-asseess/student/activationstatus/
            $stateProvider.state('activationStatus', {
                url: '/student',
                pageTitle: 'CCC_STUDENT.PAGE_TITLES.ACTIVATION_STATUS',
                template: '<ccc-route-student-activation-status></ccc-route-student-activation-status>',
            ...
            $stateProvider.state('help', {
                url: '/student/help',
                pageTitle: 'CCC_STUDENT.PAGE_TITLES.HELP',
                template: '<ccc-route-student-help></ccc-route-student-help>'
            });
