 ...
 */
public interface AssessmentPartDtoAssembler extends DtoAssembler<AssessmentPartDto, AssessmentPart> {

    @Override
    AssessmentPartDto assembleDto(AssessmentPart testPart);

    @Override
    AssessmentPart disassembleDto(AssessmentPartDto assessmentPartDto);
}
