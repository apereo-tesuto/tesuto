...
@ContextConfiguration(locations = { "classpath:/cached-repositories.xml" })
public class AssessmentItemRepositoryCacheTest {

    @Resource(name = "assessmentItemCacheRepository")
    AssessmentItemRepository assessmentItemRepository;

    public AssessmentItemRepositoryCacheTest() {
    }
    ...
    /**
     * Test of testFindByNamespaceAndId method, of 	<import resource="testPropertiesContext.xml"/>
  	<import resource="mongoTestContext.xml"/>
  	<import resource="jpaTestContext.xml"/>
	<import resource="commonImportContext.xml" />class
     * AssessmentItemRepository.
     */
    @Test
