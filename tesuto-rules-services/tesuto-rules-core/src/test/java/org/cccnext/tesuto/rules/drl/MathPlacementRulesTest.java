...
public class MathPlacementRulesTest extends DecisionTreeTestBed {
    
	private static final String RULE_FILE_NAME = "MathPlacement";
    private static final String TEST_FILE_NAME = "MathPlacement";
    private static final String TEST_SINGLE_FILE_NAME = "MathPlacementSingle";
	...
	public void testRangeOfFacts() throws Exception {
		testRangeOfFacts( RULE_FILE_NAME,TEST_FILE_NAME,  HEADER_FOOTER_FILE_NAME);
	}
	
	@Test
	public void testSingleFacts() throws Exception {
		testRangeOfFacts( RULE_FILE_NAME,TEST_SINGLE_FILE_NAME,  HEADER_FOOTER_FILE_NAME);
	}
    ...
    public void testUnquotedFacts() throws Exception {
         ...
         String rulesetHeader = FileUtils.readFileToString(new File(RULES_DIRECTORY  + HEADER_FOOTER_FILE_NAME + ".header"));
         String rulesetFooter = FileUtils.readFileToString(new File(RULES_DIRECTORY  + HEADER_FOOTER_FILE_NAME +  ".footer"));
        ...
        //kSession.addEventListener( new DebugAgendaEventListener() );
         ...
         assertEquals("Action should equal MULTIPLE_MEASURE_PLACEMENT", "MULTIPLE_MEASURE_PLACEMENT",action.getActionName());

         Map<String,Map<String,PlacementComponentActionResult>> placements = (Map<String,Map<String,PlacementComponentActionResult>>)attirbutes.get("placements");
