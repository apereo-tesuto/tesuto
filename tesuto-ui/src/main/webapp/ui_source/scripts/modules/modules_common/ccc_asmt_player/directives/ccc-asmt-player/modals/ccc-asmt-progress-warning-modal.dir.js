...
(function () {
    ...
    angular.module('CCC.AsmtPlayer').directive('cccAsmtProgressWarningModal', function () {
            ...
            template: [
                ...
                '<div autofocus tabindex="-1" id="{{modal.labelId}}">',
                    ...
                    '<div class="modal-header">',
                        ...
                        '<h3 class="modal-title text-warning">',
                            ...
                            ' <span translate="CCC_PLAYER.PROGRESS.WARNING_MODAL.TITLE"></span>',
                        '</h3>',
                    ...
                    '<div class="modal-content-wrapper">',
                        ...
                        '<div class="modal-body" id="{{modal.contentId}}">',
                            '<p translate="CCC_PLAYER.PROGRESS.WARNING_MODAL.BODY"></p>',
                        '</div>',
                    '</div>',
                ...
                '<div class="modal-footer">',
                    '<button tabindex="0" class="btn btn-primary" ng-click="continue()">',
                        '<span translate="CCC_PLAYER.PROGRESS.WARNING_MODAL.BUTTON_OKAY"></span> ',
